    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:5000/api/v1/orders/pm/searchDandR", requestOptions
            ...
            >
              ...
              <div className="border hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p className="text-black dark:text-white">{
                  (order_.region !== region || order_.point !== point) ? (
                    <span>Đã gửi đi</span>
                  ) : (
                    <span>Đã nhận</span>
                  )}</p>
              ...
              <div className="border hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p className="text-meta-5">{order_.point + " - " + order_.region}</p>
              </div>
            </div>
          ))}
        </div>
