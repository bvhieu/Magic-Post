...
const confirmPointToR = () => {
  ...
  const handleUpdate = async () => {
    ...
    const response = await fetch('http://localhost:5000/api/v1/orders/rs/changeStatus', requestOptions);
    const response2 = await fetch('http://localhost:5000/api/v1/orders/rs/changePoint', requestOptions);
