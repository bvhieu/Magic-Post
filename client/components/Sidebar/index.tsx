...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  function showSidebar() {
    if (isLoggedIn) {
      // Hiển thị sidebar "manage" khi đã đăng nhập
      // document.getElementById('manageSidebar').style.display = 'block';
    } else {
      // Ẩn sidebar "manage" khi chưa đăng nhập
      // document.getElementById('manageSidebar').style.display = 'none';
    }
  }
...
>>>>>>> 280d96a29ae387bc04247f43531a1cd44f15068f
              {/* UI Elements */}
              <SidebarLinkGroup
